...
describe("tar files", function() {
  ...
  describe(".list()", function() {
    describe("when the archive file exists", function() {
      ...
      describe("when the tree option is set to true", function() {
        ...
        describe("when the archive has multiple directories at the root", () => it("returns archive entries nested under their parent directory", function() {
          let tree = null;
