...
Supports .zip, .tar, .tar.gz, .tgz, .tar.bz2, .tbz and .tbz2 files.`).describe('colors', 'Enable colored output').default('colors', true).boolean('colors').describe('help', 'Show this message').alias('h', 'help').demand(1);
  if (cli.argv.help) {
    cli.showHelp();
    return;
  }
